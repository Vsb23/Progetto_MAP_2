...
Cliccare su \textbf{Avanti},nuovamente \textbf{Avanti} e infine, nel caso in cui l'installazione sia andata a buon fine, si dovrà cliccare sul tasto \textbf{Chiudi}.
...
\begin{figure}[h!]
    \centering
    \subfloat[Configurazione account MySQL]{
        \includegraphics[width=.45\textwidth]{images/setup vero e proio musql.png}
    }
    \hfill
    \subfloat[Completamento installazione]{
        \includegraphics[width=.45\textwidth]{images/completamenot.png}
    }
